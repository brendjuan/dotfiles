export const meta = {
  ...
  phases: [
    { title: 'Survey', detail: '10 dimension reviewers scan the diff in parallel' },
...
const DIMENSIONS = [
  ...
  { key: 'maintainability', focus: 'Maintainability & clarity: confusing names, dead code, duplication, needless complexity, missing/incorrect comments, drift from the conventions of the surrounding code.' },
